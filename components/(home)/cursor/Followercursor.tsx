...
export default function SmoothFollower() {
  ...
  return (
    <div style={{zIndex:999999999}} className="pointer-events-none lg:block hidden fixed inset-0 z-50">
      <div
        className="absolute rounded-full dark:bg-white bg-red-500 "
        style={{
          width: "8px",
          height: "8px",
      ...
      <div
        className="absolute rounded-full border dark:border-white border-green-500 "
        style={{
