...
const Studentheader: React.FC = () => {
  ...
  return (
    <div className="bg-[#D6EBF4] py-[186px] pt-[120px] lg:px-0 px-4 pb-28">
        ...
        <div className="flex lg:flex-row flex-col justify-between lg:items-center gap-10 ">
          <div className="flex gap-10 items-center">
            ...
            <div className="flex flex-col  gap-5">
              ...
              <div className="flex items-start gap-2 md:flex-row flex-col lg:items-center">
