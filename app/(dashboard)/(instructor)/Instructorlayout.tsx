...
const InstructorLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const menuItems = [
    ...
    { href: "/instructor/blogs", label: "My Blogs", icon: <FiEdit /> },
    { href: "/instructor-setting", label: "Setting", icon: <FiSettings /> },
  ];
  ...
  return (
    <div className="bg-[#f9f9fa] min-h-screen">
      <DashboardNavbar />
      <div className="flex max-w-[1536px] mx-auto w-full">
        {/* Desktop Sidebar */}
        <aside
        ...
        {/* Main Content */}
        <main className="flex-1 max-w-[1230px] md:mt-8 mx-auto px-4 py-6 bg-white rounded-lg shadow-sm">
          {children}
        </main>
      </div>
