...
const HomeTestimonials = () => {
  ...
  return (
    <section className="container sectionGap overflow-hidden  lg:scale-100 scale-90 ">
      <div className="">
        <div className=" text-center flex justify-center items-center gap-2 flex-col">
          <h1
            data-aos="fade-up"
            data-aos-delay="400"
            className="font-bold text-[40px] text-black-color"
          >
            প্রফেশনালদের চোখে <span className="text-[#3CB449]"> ICTBangla</span>
          </h1>
          <p
            data-aos="fade-up"
            data-aos-delay="500"
            className=" text-text-secondary text-xl font-medium tracking-[0.4px]"
          >
        ...
        <div
          data-aos="fade-up"
          data-aos-delay="600"
          className="relative flex items-center justify-center mb-4  mx-auto mt-16 max-w-[1080px]"
        >
          <button
            aria-label="Previous"
            ...
            {avatars.map((avatar, index) => (
              <SwiperSlide key={index} className="cursor-pointer">
                <Image
                  src={avatar?.src ?? ""}
                  alt={avatar.alt}
                  className="thum w-full h-full rounded-lg object-cover "
                />
              </SwiperSlide>
            ))}
          </Swiper>
          ...
          >
            {testimonials.map((testimonial, index) => (
              <SwiperSlide key={index}>
                <div className="lg:p-6 p-3 lg:mx-4 mx-2 flex flex-col justify-center items-center gap-3 text-center ">
                  <h3 className="text-lx font-bold text-[#313131]">
                    {testimonial.name}
                  </h3>
                  <h3 className="text-xl font-bold tracking-[0.4px] text-[#26A243]">
                    {testimonial.role}
                  </h3>
                  ...
                  <h2 className=" lg:w-[800px] w-full mx-auto text-lg font-medium text-[#707070]  mt-2 text-center">
                    &quot;{testimonial.text}&quot;
                  </h2>
                </div>
              </SwiperSlide>
