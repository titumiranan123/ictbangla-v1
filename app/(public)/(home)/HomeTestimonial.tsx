...
const HomeTestimonials = () => {
  ...
  return (
    <section className="container overflow-hidden section lg:scale-100 scale-90 ">
      <div className="">
            ...
            {testimonials.map((testimonial, index) => (
              <SwiperSlide key={index}>
                <div className="lg:p-6 p-3 lg:mx-4 mx-2 center-content gap-0">
                  <h3 className="lg:text-[24px] text-[18px] font-[600] text-gray-800">
                    {testimonial.name}
                  </h3>
                  <h3 className="lg:text-[20px] text-[18px] font-[400] text-[#26A243]">
                    {testimonial.role}
                  </h3>
