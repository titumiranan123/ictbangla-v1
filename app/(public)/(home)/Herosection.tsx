      ...
      <div className=" lg:h-[700px] h-full overflow-hidden bg  ">
        ...
        >
          ...
          <div className="xl:max-w-[834px] md:max-w-[600px]   flex w-full flex-col gap-6">
            ...
            <p
              className="xl:text-xl lg:text-[16px] xl:leading-[26px] lg:leading-[22.5px] xl:w-[82%] font-medium text-[#797878]"
              data-aos="fade-up"
              data-aos-delay="300"
            >
              বর্তমান সময়ে ক্যারিয়ার গড়তে দরকার দক্ষতা। এই প্ল্যাটফর্মে ঘরে বসে,
              অফিসে কিংবা বাইরে নিজ সুবিধামতো আন্তর্জাতিক মানের কোর্স করে
              ক্যারিয়ার বা ফ্রিল্যান্সিং শুরু করা সম্ভব।
            </p>
