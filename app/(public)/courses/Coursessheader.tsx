...
const CoursesHeroSectionWithRings: React.FC<PropsType> = ({
  title,
  subTitle,
  buttonText,
}) => {
  ...
  return (
    <>
      ...
      `}
              ...
              <button
                onClick={() => {
                  router.replace(`?courseType=LIVE_COURSE`, {
                    scroll: false,
                  });
                }}
                className="relative z-10 bg-white rounded-[8px] py-[10px] px-[16px] text-primary text-lg font-bold whitespace-nowrap"
              >
                {buttonText}
              </button>
            </div>
            <div className="animate-stroke  duration-400 transition-all flex justify-center items-center rounded-[8px] overflow-hidden z-20 p-[1.5px] cursor-pointer relative ">
              <button
                onClick={() => {
                  router.replace(`?courseType=RECORDED_COURSE`, {
                    scroll: false,
                  });
                }}
                className="relative z-10 bg-white rounded-[8px] py-[10px] px-[16px] text-primary text-lg font-bold whitespace-nowrap"
...
export default CoursesHeroSectionWithRings;
