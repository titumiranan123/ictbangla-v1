...
const AddCompare = ({ data }: { data: any }) => {
  return (
    <div className="max-w-full sticky top-32 w-full lg:max-h-[80px] h-full  border-l-8 border-[#29AE48] flex justify-between lg:flex-nowrap flex-wrap  items-center gap-4 mt-1 px-5 py-6 bg-white">
